...
# This script is dedicated to eof analysis
TARGET_LABEL = 'eof'
...
def main():
    """
    Main function to train and evaluate a Logistic Regression model for eof analysis.
    """
    ...
    # We use the 'saga' solver as it's versatile and supports all penalties.
