...
EMBEDDINGS_PATH = 'embeddings_eof.npy'
LABELS_PATH = 'labels_eof.csv'
TARGET_LABEL = 'eof'  # This script is dedicated to eof analysis
...
def main():
    """
    Main function to train and evaluate an SVC model for eof analysis.
    """
    # 1. Load Embeddings and Labels
    print("Loading pre-generated eof embeddings and labels...")
    ...
    # 3. Define Pipeline and Grid for SVC
    ...
    # 4. Training with GridSearchCV
    print(f"\nStarting GridSearchCV for '{TARGET_LABEL}'...")
