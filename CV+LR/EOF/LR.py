...
# Drop rows where 'text' or 'eof' are missing
...
# IMPORTANT: Filter out rows where 'eof' is 'na'
...
# ========== 2. Split ==========
X_train, X_temp, y_train, y_temp = train_test_split(df['text'], df['eof'], test_size=0.3, stratify=df['eof'], random_state=42)
